...
class StreamingTest {
  ...
  void should_be_able_to_turn_array_into_stream() {
    ...
    // TODO: please modify the following code to pass the test
    // <--start
    try (Stream<String> wordStream = Arrays.stream(words))
    // --end-->
    {
      assertArrayEquals(
          words,
  ...
  void should_be_able_to_generate_infinite_stream_of_sequence() {
    // TODO: please modify the following code to pass the test
    // <--start
    try (Stream<Integer> infiniteSequence = Stream.iterate(0, number -> number + 1))
    // --end-->
    {
  ...
  void should_be_able_to_filter_stream() {
    ...
    // <--start
    try (Stream<String> filtered = wordStream.filter(str -> str.length() > 4))
    // --end-->
    {
  ...
  void should_flatten_stream_of_streams() {
    ...
    // TODO: please modify the following code to pass the test
    // <--start
    try (Stream<Character> flatted = nameStream.flatMap(letter -> letter))
    // --end-->
    {
      assertArrayEquals(
          new Character[]{
